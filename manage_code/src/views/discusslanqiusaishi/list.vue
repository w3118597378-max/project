			...
			<div class="page_shell">
				...
				<div class="page_container">
					<div class="page_header">
						<div class="page_header__left">
							...
							<div class="page_titles">
								<div class="page_title">赛事评论管理</div>
								<div class="page_subtitle">维护篮球赛事评论内容、置顶与账号状态</div>
							</div>
						</div>
					...
					<div class="search_card list_search_view">
						...
						<div class="btn_view">
							<el-button class="btn_primary" type="success" @click="addClick" v-if="btnAuth('discusslanqiusaishi','新增')">新增</el-button>
					...
					<div class="table_card">
						<el-table
							...
							<el-table-column v-if="btnAuth('discusslanqiusaishi','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
								<template #default="scope">
									<div @click.stop>
							...
							<el-table-column label="操作" class-name="operation-cell" width="300"  :resizable='true' :sortable='false' align="left" header-align="left">
								<template #default="scope">
									<el-button class="btn_secondary" type="primary" v-if=" btnAuth('discusslanqiusaishi','修改')" @click.stop="editClick(scope.row.id,scope.row)">修改</el-button>
									<el-button class="btn_danger" type="danger" @click.stop="delClick(scope.row.id,scope.row)">删除</el-button>
									<el-button class="btn_secondary" v-if="btnAuth('discusslanqiusaishi','查看评论')" type="warning" @click.stop="commentClick(scope.row.id)">查看评论</el-button>
...
<script setup>
	...
	//基础信息
	const tableName = 'discusslanqiusaishi'
	const formName = '篮球赛事评论表'
	...
	const delClick = (id,row={}) => {
		...
		ElMessageBox.confirm(`是否删除选中${formName}`, '提示', {
			...
			context.$http({
                ...
                context.$http.get(`lanqiusaishi/info/${route.query.refid}`).then(res=>{
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscusslanqiusaishi?refid=' + id)
	}
