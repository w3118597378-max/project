				...
				<div class="page_container">
					<div class="page_header">
						<div class="page_header__left">
							<div class="page_icon">
								<ChartLine class="page_icon__svg" />
							</div>
							<div class="page_titles">
								<div class="page_title">比赛技术统计管理</div>
								<div class="page_subtitle">维护技术统计记录并支持可视化统计</div>
							</div>
						</div>
					</div>
					...
					<div class="search_card list_search_view">
						...
						<div class="btn_view">
							<el-button class="btn_primary" type="success" @click="addClick" v-if="btnAuth('bisaijishutongji','新增')">新增</el-button>
							<el-button class="btn_danger" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)" v-if="btnAuth('bisaijishutongji','删除')">删除</el-button>
							<el-button class="btn_secondary" type="warning" @click.stop="echartClick1" v-if="btnAuth('bisaijishutongji','比赛技术统计')">比赛技术统计</el-button>
						</div>
					</div>
					...
					<div class="table_card">
						<el-table
							...
							<el-table-column label="操作" class-name="operation-cell" width="300"  :resizable='true' :sortable='false' align="left" header-align="left">
								<template #default="scope">
									<el-button class="btn_secondary" type="info" v-if=" btnAuth('bisaijishutongji','查看')" @click.stop="infoClick(scope.row.id)">详情</el-button>
									<el-button class="btn_secondary" type="primary" v-if=" btnAuth('bisaijishutongji','修改')" @click.stop="editClick(scope.row.id,scope.row)">修改</el-button>
									<el-button class="btn_danger" type="danger" v-if="btnAuth('bisaijishutongji','删除')" @click.stop="delClick(scope.row.id,scope.row)">删除</el-button>
								</template>
							</el-table-column>
						</el-table>
					</div>
...
<script setup>
	...
	import { ChartLine, Search } from 'lucide-vue-next'
	//基础信息
