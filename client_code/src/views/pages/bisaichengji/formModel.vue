	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">成绩比分</div>

					<div  class="info_text" >{{detail.chengjibifen}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">比赛结果</div>

					<div  class="info_text" >{{detail.bisaijieguo}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">特殊事件</div>

					<div  class="info_text" >{{detail.teshushijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">判罚说明</div>

					<div  class="info_text" >{{detail.panfashuoming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('bisaichengji','申请')" @click="jinjishenqingonAcross('申请','','','','')" type="warning">申请</el-button>
