    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('bisaichengji','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="成绩比分" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.chengjibifen}}
							</template>
						</el-table-column>
						<el-table-column label="比赛结果" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.bisaijieguo}}
							</template>
						</el-table-column>
						<el-table-column label="特殊事件" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.teshushijian}}
							</template>
						</el-table-column>
						<el-table-column label="判罚说明" :resizable='true' align="center" header-align="center">
							<template #default="scope">
								{{scope.row.panfashuoming}}
							</template>
						</el-table-column>
						<el-table-column label="发布时间" :resizable='true' align="center" header-align="center">
							<template #default="scope">
