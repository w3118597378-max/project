	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">球队积分</div>

					<div  class="info_text" >{{detail.qiuduijifen}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">比赛排名</div>

					<div  class="info_text" >{{detail.bisaipaiming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">晋级赛事</div>

					<div  class="info_text" >{{detail.jinjisaishi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('jinjishenqing','结果')" @click="jinjibisaijieguoonAcross('结果','是','','','')" type="warning">结果</el-button>
					<el-button class="approval_btn" v-if="btnAuth('jinjishenqing','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jinjishenqing','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jinjishenqing','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
