	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">参赛队员</div>

					<div  class="info_text" >{{detail.cansaiduiyuan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">球队名称</div>

					<div  class="info_text" >{{detail.qiuduimingcheng}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('bisaibaoming','日程')" @click="jingsairichengonAcross('日程','是','','','')" type="warning">日程</el-button>
					<el-button class="cross_btn" v-if="btnFrontAuth('bisaibaoming','记录')" @click="bisaijishutongjionAcross('记录','是','','[1]','已记录')" type="warning">记录</el-button>
					<el-button class="cross_btn" v-if="btnFrontAuth('bisaibaoming','成绩')" @click="bisaichengjionAcross('成绩','是','','','')" type="warning">成绩</el-button>
					<el-button class="approval_btn" v-if="btnAuth('bisaibaoming','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
