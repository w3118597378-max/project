	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">首发阵容</div>

					<div  class="info_text" >{{detail.shoufazhenrong}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">对阵队伍</div>

					<div  class="info_text" >{{detail.duizhenduiwu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">上场球员</div>
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jingsairicheng','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jingsairicheng','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
