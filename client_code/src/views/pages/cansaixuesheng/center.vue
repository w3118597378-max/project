						...
						<el-row :gutter="6">
							<el-col :span="12">
								<el-form-item prop="xuehao" label="学号">
									<el-input class="form-input" v-model="userForm.xuehao" placeholder="学号" readonly></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item prop="xingming" label="姓名">
									<el-input class="form-input" v-model="userForm.xingming" placeholder="姓名" ></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
							...
							<el-col :span="12">
								<el-form-item prop="nianling" label="年龄">
									<el-input class="form-input" v-model="userForm.nianling" placeholder="年龄" ></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="24">
							...
							<el-col :span="12">
								<el-form-item prop="shouji" label="手机">
									<el-input class="form-input" v-model="userForm.shouji" placeholder="手机" ></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item prop="email" label="邮箱">
									<el-input class="form-input" v-model="userForm.email" placeholder="邮箱" ></el-input>
								</el-form-item>
							</el-col>
						</el-row>
