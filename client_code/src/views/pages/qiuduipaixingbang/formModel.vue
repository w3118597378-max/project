			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.qiuduimingcheng}}</span>
					</div>
				...
				<div class="info_item">
					<div class="info_label">教练名称</div>

					<div  class="info_text" >{{detail.jiaolianmingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">球员人数</div>

					<div  class="info_text" >{{detail.qiuyuanrenshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">胜</div>

					<div  class="info_text" >{{detail.sheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">负</div>

					<div  class="info_text" >{{detail.fu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">平</div>

					<div  class="info_text" >{{detail.ping}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">胜率</div>

					<div  class="info_text" >{{detail.shenglv}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">是否在招募</div>

					<div  class="info_text" >{{detail.shifouzaizhaomu}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">创立时间</div>

					<div  class="info_text" >{{detail.chuanglishijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">球队口号</div>

					<div  class="info_text" >{{detail.qiuduikouhao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">球员名单</div>

					<div  class="info_text" >{{detail.qiuyuanmingdan}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">队长账号</div>

					<div  class="info_text" >{{detail.duizhangzhanghao}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">队长姓名</div>

					<div  class="info_text" >{{detail.duizhangxingming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('qiuduipaixingbang','申请加入')" @click="jiaruqiuduionAcross('申请加入','是','','','')" type="warning">申请加入</el-button>
					<el-button class="approval_btn" v-if="btnAuth('qiuduipaixingbang','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('qiuduipaixingbang','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('qiuduipaixingbang','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="球队介绍" name="first">
