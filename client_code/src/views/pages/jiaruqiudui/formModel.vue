	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('jiaruqiudui','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiaruqiudui','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiaruqiudui','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
