	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">得分</div>

					<div  class="info_text" >{{detail.defen}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">犯规</div>

					<div  class="info_text" >{{detail.fangui}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">暂停</div>

					<div  class="info_text" >{{detail.zanting}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">记录时间</div>

					<div  class="info_text" >{{detail.jilushijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('bisaijishutongji','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('bisaijishutongji','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
