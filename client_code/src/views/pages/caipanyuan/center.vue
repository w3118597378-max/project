						...
						<el-row :gutter="6">
							<el-col :span="12">
								<el-form-item prop="caipanzhanghao" label="裁判账号">
									<el-input class="form-input" v-model="userForm.caipanzhanghao" placeholder="裁判账号" readonly></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item prop="caipanxingming" label="裁判姓名">
									<el-input class="form-input" v-model="userForm.caipanxingming" placeholder="裁判姓名" ></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="24">
							...
							<el-col :span="12">
								<el-form-item prop="shoujihaoma" label="手机号码">
									<el-input class="form-input" v-model="userForm.shoujihaoma" placeholder="手机号码" ></el-input>
								</el-form-item>
							</el-col>
						</el-row>
